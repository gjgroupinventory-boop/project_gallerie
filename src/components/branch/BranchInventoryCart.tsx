...
import { X, ShoppingBag, Sparkles, Trash2, Image as ImageIcon, CheckCircle2, Clock, ArrowRightLeft, Frame, RotateCcw, ArrowLeft, ClipboardCheck, ChevronRight, AlertTriangle, Upload, Wrench } from 'lucide-react';
